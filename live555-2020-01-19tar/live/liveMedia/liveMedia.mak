...
#TARGETOS = WIN95
#APPVER = 4.0
#https://gist.github.com/ekkiiiii/a945aea9070b373527f43319299ee0e8
#!include    <ntwin32.mak>
...
TOOLS32	=		C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Tools\MSVC\14.16.27023
...
LIBRARY_LINK =		lib /out:
LINK_OPTS_0 =		$(linkdebug) msvcrt.lib /NODEFAULTLIB:libcmt.lib
LIBRARY_LINK_OPTS =	
...
RTSP_OBJS = RTSPServer.$(OBJ) RTSPServerRegister.$(OBJ) RTSPClient.$(OBJ) RTSPCommon.$(OBJ) RTSPServerSupportingHTTPStreaming.$(OBJ) RTSPRegisterSender.$(OBJ) TLSState.$(OBJ)
